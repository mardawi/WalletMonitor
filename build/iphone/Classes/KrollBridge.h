...
@interface WalletMonitorObject : KrollCoverageObject {
#else
@interface WalletMonitorObject : KrollObject {
#endif
@private
...
extern NSString * WalletMonitor$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	WalletMonitorObject *_walletmonitor;
    KrollObject* console;
	BOOL shutdown;
