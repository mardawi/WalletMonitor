 ...
 * Copyright (c) 2009-2011 by WalletMonitor, Inc. All Rights Reserved.
...
//@interface WalletMonitorObject : NSObject
//@end

@interface WalletMonitorObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WalletMonitorObject class]])
		{
			for (NSString *key in [[(WalletMonitorObject*)o modules] allKeys])
			{
