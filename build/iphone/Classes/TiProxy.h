...
//Rare exceptions to indicate a bug in the _walletmonitor code (Eg, function that a subclass should have implemented)
...
/**
 The base class for WalletMonitor proxies.
 */
