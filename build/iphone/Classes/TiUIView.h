...
/**
 Base class for all WalletMonitor views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the WalletMonitor view hierarchy (such as wrapped iOS UIViews) was touched.
