...
// in simulator we redefine to format for WalletMonitor Developer console
...
{\
	NSString * exceptionName = [@"org.walletmonitor." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.walletmonitor";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIWalletMonitorNativeItemNone = -1, 
	UIWalletMonitorNativeItemSpinner = -2,
	UIWalletMonitorNativeItemProgressBar = -3,
	
	UIWalletMonitorNativeItemSlider = -4,
	UIWalletMonitorNativeItemSwitch = -5,
	UIWalletMonitorNativeItemMultiButton = -6,
	UIWalletMonitorNativeItemSegmented = -7,
	
	UIWalletMonitorNativeItemTextView = -8,
	UIWalletMonitorNativeItemTextField = -9,
	UIWalletMonitorNativeItemSearchBar = -10,
	
	UIWalletMonitorNativeItemPicker = -11,
	UIWalletMonitorNativeItemDatePicker = -12,
	
	UIWalletMonitorNativeItemInfoLight = -13,
	UIWalletMonitorNativeItemInfoDark = -14,
	
	UIWalletMonitorNativeItemDisclosure = -15,
	
	UIWalletMonitorNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all WalletMonitor instances of
